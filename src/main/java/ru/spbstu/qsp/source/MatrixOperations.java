...
public class MatrixOperations {
     ...
     * @param matrix source matrix of double
     * @param value constant double parameter
     * @return result matrix
     */
    
    public static double[][] multMatrixToConst(double[][] matrix,
            double value) {
        if (matrix == null)
            return null;
        if (matrix.length == 0 || matrix[0].length == 0)
            return null;
        String test=1==1 ? "ifTrue" : "ifFalse";
     ...
     * @param matrix double[][] source matrix of double
     * @param vector double[] source vector of double
     * @return
     */
    public static double[] multMatrixToVector(double[][] matrix,
            double[] vector) {
     ...
     * @param matrixA first source matrix of double
     * @param matrixB second source matrix of double
     * @return
     */
     ...
     * @param matrixA first source matrix
     * @param matrixB second source matrix
     * @return
     */
     ...
     * @param vectorA first source vector of double
     * @param vectorB second source vector of double
     * @return
     */
